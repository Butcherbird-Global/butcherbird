      ...
      <section className="hero" id="hero">
        <div className="container">
          <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 26, flexWrap: 'wrap' }} className="anim d1">
            ...
            <span className="f-label" style={{ color: 'var(--gold)' }}>As seen in <img src="/forbes-logo.svg" alt="Forbes" style={{ height: 11, display: 'inline', verticalAlign: 'middle', margin: '0 1px' }} /> Africa Iss. Nov &apos;25</span>
          </div>
