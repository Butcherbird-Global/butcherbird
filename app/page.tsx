              ...
              {[
                ...
                <div key={member.name} className="team-card">
                  <div className="team-img-ph">
                    {member.image
                      ? <Image src={member.image} alt={member.name} fill style={{ objectFit: member.name === 'Aamir Sayed' ? 'contain' : 'cover', objectPosition: (member.name === 'Rhett Tomlinson' || member.name === 'Aamir Sayed') ? 'bottom' : 'top' }} />
