...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    website: 'https://www.bonniebio.co.za',
    instagram: '@bonniebiobiodegradable',
    subtitle: 'The online engine behind a retail brand',
    desc: "A retail brand people now actively look for on the shelf — because we put them in front of 1.83 million people online first.",
    metrics: [
      { val: '1.83M', lbl: 'People reached' },
      { val: '6.47M', lbl: 'Impressions served' },
      { val: '388K', lbl: 'Video views' },
      { val: 'R213K', lbl: 'Media invested' },
    ],
    story:
  ...
  },
  {
    ...
    website: 'https://superior.africa',
    instagram: '@superiorfragrances.official',
    ...
    metrics: [
      ...
      { val: '4.30×', lbl: 'Best static ROAS' },
      { val: 'R346K+', lbl: 'Revenue tracked' },
      { val: 'Since \'23', lbl: 'Active since' },
    ],
    story:
  ...
  },
  {
    ...
    website: 'https://buub.co.za',
    instagram: '@buubsunscreen',
  ...
  },
  {
    ...
    website: 'https://www.shootstudios.co.za',
  ...
  },
  {
    ...
    website: 'https://schnozzstrips.store',
    instagram: '@schnozzstrips',
    subtitle: 'Nasal strips to multi-product retail brand — 200+ doors',
    desc: 'R3.4M+ in revenue. 8,500+ purchases. R823K in a single month. Built in under 12 months from a single SKU.',
    metrics: [
      { val: '3.03×', lbl: 'Blended ROAS' },
      { val: 'R3.4M+', lbl: 'Revenue (12 months)' },
      { val: 'R823K', lbl: 'Best month (Jul \'25)' },
      { val: '8,505', lbl: 'Purchases tracked' },
